...
<div class="about d-flex flex-column justify-content-center">
  <div class=" about row d-flex justify-content-start align-items-center">
    ...
    <div class="col-lg-5 col-md-12 col-sm-12">
      ...
      <div class="button-group d-flex flex-wrap">
        <button type="button" class="btn btn-primary col-lg-5 col-md-5 col-sm-5 d-flex align-items-center justify-content-between"><p>Request Early Access</p>
        ...
        <button type="button" class="btn btn-outline-secondary col col-lg-5 col-md-5 col-sm-5 d-flex align-items-center justify-content-between"><p>Whitepaper</p>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-right" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M14 13.5a.5.5 0 0 1-.5.5h-6a.5.5 0 0 1 0-1h4.793L2.146 2.854a.5.5 0 1 1 .708-.708L13 12.293V7.5a.5.5 0 0 1 1 0v6z"/>
          </svg>
        </button>
    ...
    <div class="col-lg-5 col-md-12 col-sm-12 justify-content-center">
      <img src="../static/headerImage.png">
    </div>
  </div>
</div>
</template>
